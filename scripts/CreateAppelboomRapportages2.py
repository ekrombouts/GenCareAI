...
for ct in appelboom_clienten['clienten']:
    ...
    #Genereer 10 weken aan rapportages
    ct_rapportages = genereer_rapportages(s_role=s_role_content, u_role=u_role_content, model=model, seed=seed, n=num_weeks)
